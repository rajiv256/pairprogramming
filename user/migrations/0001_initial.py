# Generated by Django 2.0.4 on 2018-08-23 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_summary', models.TextField(default='My Awesome project', max_length=500)),
            ],
        ),
        migrations.CreateModel(
            name='Relationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(1, 'Following'), (2, 'Blocked'), (3, 'Pending')])),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_name', models.CharField(default='bopkfo', max_length=100)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='user_projects', to='user.User'),
        ),
        migrations.AddField(
            model_name='idea',
