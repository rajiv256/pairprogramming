...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_name', models.CharField(default='psyhjc', max_length=100)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='interested_topics', to='user.User'),
        ),
        migrations.AddField(
            model_name='topic',
            name='topic_ideas',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Idea'),
        ),
        migrations.AddField(
